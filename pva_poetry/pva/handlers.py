...
from .output_interface import ContactsOutput, ContactOutput, HelpOutput
...
def handler_show_all(_, contact_dictionary: AddressBook, __) -> list:
    ...
    all_list.append(output.create_output(contact_dictionary))
    return all_list
...
def handler_show(user_command: list, contact_dictionary: AddressBook, _=None) -> str:
    ...
    return output.create_output(name, contact_dictionary)
